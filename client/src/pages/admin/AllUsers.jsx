    ...
    return (
        <motion.div
            ...
            <div className="card-body">
                <h2 className="card-title">All Users <div className="bg-darkFrom text-gray-100 p-1 rounded-md">Clients</div> </h2>
                <hr />
                ...
                {loading ? (
                    ...
                    <table className="min-w-full text-sm border border-gray-100 divide-y-2 divide-gray-200">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {
                                users.map((item, index) => <tr key={index} className="divide-x divide-gray-100 hover:shadow-md">
